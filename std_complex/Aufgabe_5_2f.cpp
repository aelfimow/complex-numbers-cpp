...
void Aufgabe_5_2f()
{
    // Using float
    {
        std::complex<float> const z = -2.0f - 2.0if;
    ...
    // Using double
    {
        std::complex<double> const z = -2.0 - 2.0i;
    ...
    // Using long double
    {
        std::complex<long double> const z = -2.0L - 2.0iL;
    ...
    // Using: __float128
    {
        std::complex<__float128> const z(-2.0Q, -2.0Q);
