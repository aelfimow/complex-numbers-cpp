...
void Aufgabe_5_2e()
{
    // Using float
    {
        std::complex<float> const z = 4.0if;
    ...
    // Using double
    {
        std::complex<double> const z = 4.0i;
    ...
    // Using long double
    {
        std::complex<long double> const z = 4.0iL;
    ...
    // Using: __float128
    {
        std::complex<__float128> const z(0.0Q, 4.0Q);
