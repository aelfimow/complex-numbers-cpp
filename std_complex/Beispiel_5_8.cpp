...
/**
 * \brief Beispiel 5.8 with z2
 * \see Book1.md, (Seite 304)
 */
static void Beispiel_5_8_2()
{
    // Using: float
    {
        std::complex<float> const z = (-2.0f * ::sqrtf(3.0f)) + 2.0if;
...
/**
 * \brief Beispiel 5.8 with z3
 * \see Book1.md, (Seite 304)
 */
static void Beispiel_5_8_3()
{
    // Using: float
    {
        std::complex<float> const z = (-2.0f * ::sqrtf(3.0f)) - 2.0if;
...
/**
 * \brief Beispiel 5.8 with z4
 * \see Book1.md, (Seite 304)
 */
static void Beispiel_5_8_4()
{
    // Using: float
    {
        std::complex<float> const z = (2.0f * ::sqrtf(3.0f)) - 2.0if;
